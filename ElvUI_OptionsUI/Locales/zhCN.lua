...
L["Configure how recipe items are displayed in bags. Recipe items will not show BoE/BoU text."] = "配置在背包中如何显示配方物品。配方物品将不显示 BoE/BoU 文本。"
...
L["Display abbreviated profession name on recipe items (e.g., BS for Blacksmithing)."] = "在配方物品上显示职业简称（例如：BS 表示锻造）。"
...
L["Keybind Text"] = "键位文字"
L["Known Color"] = "已学颜色"
L["Known Recipe Overlay"] = "已学配方覆盖层"
...
L["YELL"] = "大喊"
L["Icon Size"] = "图标大小"
L["Set the size of the map markers"] = "设置地图标记的大小"
L["Receive from Raid Members"] = "从 Raid 成员处接收"
L["Allows Raid Members to send you Map Markers"] = "允许 Raid 成员向您发送地图标记"
L["MAP_MARKER_DISCRIPTION"] = "允许通过在世界地图上单击鼠标中键 (Mouse3) 创建地图标记。\n标记会自动与 raid 成员共享。"
