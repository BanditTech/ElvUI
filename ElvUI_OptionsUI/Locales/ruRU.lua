...
L["Configure how recipe items are displayed in bags. Recipe items will not show BoE/BoU text."] = "Настроить отображение предметов рецептов в сумках. Предметы рецептов не будут показывать текст BoE/BoU."
...
L["Display abbreviated profession name on recipe items (e.g., BS for Blacksmithing)."] = "Показывать сокращённое название профессии на предметах рецептов (напр., КЗ для кузнечного дела)."
...
L["Known Color"] = "Цвет (известно)"
L["Known Recipe Overlay"] = "Оверлей для известных рецептов"
...
L["Show colored overlay for recipes that cannot be learned (wrong profession, level requirement not met, etc.)."] = "Показывать цветной оверлей для рецептов, которые нельзя изучить (не та профессия, не хватает уровня и т.д.)."
L["Show colored overlay for recipes that are not yet known and can be learned."] = "Показывать цветной оверлей для рецептов, которые ещё не известны, но могут быть изучены."
L["Show colored overlay for recipes that are already known."] = "Показывать цветной оверлей для уже известных рецептов."
L["Show Profession Text"] = "Показывать название профессии"
...
L["Unknown Color"] = "Цвет (неизвестно)"
L["Unknown Recipe Overlay"] = "Оверлей для неизвестных рецептов"
L["Unlearnable Color"] = "Цвет (нельзя изучить)"
L["Unlearnable Recipe Overlay"] = "Оверлей для рецептов, которые нельзя выучить"
L["Up"] = "Вверх"
...
L["Set the size of the map markers"] = "Установить размер маркеров карты"
L["Receive from Raid Members"] = "Получить от участников рейда"
L["Allows Raid Members to send you Map Markers"] = "Позволяет участникам рейда отправлять вам маркеры карты"
L["MAP_MARKER_DISCRIPTION"] = "Позволяет создавать маркеры карты, щелкнув средней кнопкой мыши (Mouse3) на карте мира.\nМаркеры автоматически передаются участникам рейда."
