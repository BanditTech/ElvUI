...
L["Configure how recipe items are displayed in bags. Recipe items will not show BoE/BoU text."] = "Configura como os itens de receita são exibidos nas bolsas. Itens de receita não mostrarão texto BoE/BoU."
...
L["Display abbreviated profession name on recipe items (e.g., BS for Blacksmithing)."] = "Exibir nome abreviado da profissão nos itens de receita (ex.: FS para Ferraria)."
...
L["Known Color"] = "Cor (conhecido)"
L["Known Recipe Overlay"] = "Sobreposição para receitas conhecidas"
...
L["Show Coins"] = true
L["Show colored overlay for recipes that cannot be learned (wrong profession, level requirement not met, etc.)."] = "Mostrar sobreposição colorida para receitas que não podem ser aprendidas (profissão errada, requisito de nível não atendido, etc.)."
L["Show colored overlay for recipes that are not yet known and can be learned."] = "Mostrar sobreposição colorida para receitas que ainda não são conhecidas e podem ser aprendidas."
L["Show colored overlay for recipes that are already known."] = "Mostrar sobreposição colorida para receitas já conhecidas."
L["Show Profession Text"] = "Mostrar texto da profissão"
...
L["Unknown Color"] = "Cor (desconhecido)"
L["Unknown Recipe Overlay"] = "Sobreposição para receitas desconhecidas"
L["Unlearnable Color"] = "Cor (não aprendível)"
L["Unlearnable Recipe Overlay"] = "Sobreposição para receitas não aprendíveis"
L["Up"] = "Acima"
L["Usable"] = true
L["Use Alt Key"] = true
...
L["Set the size of the map markers"] = "Defina o tamanho dos marcadores do mapa"
L["Receive from Raid Members"] = "Receba dos membros do Raid"
L["Allows Raid Members to send you Map Markers"] = "Permite que os membros do Raid enviem marcadores de mapa para você"
L["MAP_MARKER_DISCRIPTION"] = "Permite que marcadores de mapa sejam criados clicando com o botão do meio (Mouse3) no mapa-múndi.\nMarcadores são automaticamente compartilhados com os membros do raide."
