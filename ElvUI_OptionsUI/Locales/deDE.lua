...
L["Configure how recipe items are displayed in bags. Recipe items will not show BoE/BoU text."] = "Legt fest, wie Rezeptgegenstände in Taschen angezeigt werden. Rezeptgegenstände zeigen keinen BoE/BoU-Text."
...
L["Known Color"] = "Farbe (bekannt)"
L["Known Recipe Overlay"] = "Overlay für bekannte Rezepte"
...
L["Show colored overlay for recipes that cannot be learned (wrong profession, level requirement not met, etc.)."] = "Färbige Überlagerung für Rezepte anzeigen, die nicht erlernbar sind (falscher Beruf, nicht erfüllte Stufenanforderung usw.)."
L["Show colored overlay for recipes that are not yet known and can be learned."] = "Färbige Überlagerung für Rezepte anzeigen, die noch nicht bekannt, aber erlernbar sind."
L["Show colored overlay for recipes that are already known."] = "Färbige Überlagerung für bereits bekannte Rezepte anzeigen."
L["Show Profession Text"] = "Berufsname anzeigen"
...
L["Unknown Color"] = "Farbe (unbekannt)"
L["Unknown Recipe Overlay"] = "Overlay für unbekannte Rezepte"
L["Unlearnable Color"] = "Farbe (nicht erlernbar)"
L["Unlearnable Recipe Overlay"] = "Overlay für nicht erlernbare Rezepte"
L["Up"] = "Hinauf"
L["Usable"] = "Nutzbar"
