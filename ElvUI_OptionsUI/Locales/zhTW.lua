...
L["Configure how recipe items are displayed in bags. Recipe items will not show BoE/BoU text."] = "設定配方物品在背包中的顯示方式。配方物品不會顯示 BoE/BoU 文字。"
...
L["Display abbreviated profession name on recipe items (e.g., BS for Blacksmithing)."] = "在配方物品上顯示職業縮寫（例如：BS 表示鍛造）。"
...
L["Keywords"] = "關鍵字"
L["Known Color"] = "已學顏色"
L["Known Recipe Overlay"] = "已學配方覆蓋層"
L["LBF Support"] = true
...
L["Show Coins"] = "顯示硬幣"
L["Show colored overlay for recipes that cannot be learned (wrong profession, level requirement not met, etc.)."] = "對無法學習的配方顯示彩色覆蓋（職業不符、等級未達等）。"
L["Show colored overlay for recipes that are not yet known and can be learned."] = "對尚未學會但可學習的配方顯示彩色覆蓋。"
L["Show colored overlay for recipes that are already known."] = "對已學會的配方顯示彩色覆蓋。"
...
L["Unknown Color"] = "未學顏色"
L["Unknown Recipe Overlay"] = "未知配方覆蓋層"
L["Unlearnable Color"] = "不可學顏色"
L["Unlearnable Recipe Overlay"] = "不可學配方覆蓋層"
L["Up"] = "上"
L["Usable"] = "可以使用"
...
L["YELL"] = "大喊"
L["Icon Size"] = "圖標大小"
L["Set the size of the map markers"] = "設置地圖標記的大小"
L["Receive from Raid Members"] = "從 Raid 成員處接收"
L["Allows Raid Members to send you Map Markers"] = "允許 Raid 成員向您發送地圖標記"
L["MAP_MARKER_DISCRIPTION"] = "允許通過在世界地圖上單擊鼠標中鍵 (Mouse3) 創建地圖標記。 \n標記會自動與 raid 成員共享。"
