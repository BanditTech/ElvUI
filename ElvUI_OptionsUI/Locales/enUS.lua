...
L["Configure how recipe items are displayed in bags. Recipe items will not show BoE/BoU text."] = true
...
L["Display abbreviated profession name on recipe items (e.g., BS for Blacksmithing)."] = true
...
L["Show Coins"] = true
L["Show colored overlay for recipes that cannot be learned (wrong profession, level requirement not met, etc.)."] = true
L["Show colored overlay for recipes that are not yet known and can be learned."] = true
L["Show colored overlay for recipes that are already known."] = true
...
L["Unit Type"] = true
L["UnitFrames"] = true
L["Unknown Color"] = true
L["Unknown Recipe Overlay"] = true
L["Unlearnable Color"] = true
L["Unlearnable Recipe Overlay"] = true
