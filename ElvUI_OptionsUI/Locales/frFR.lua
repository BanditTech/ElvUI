...
L["Configure how recipe items are displayed in bags. Recipe items will not show BoE/BoU text."] = "Configurer l'affichage des objets de recette dans les sacs. Les objets de recette n'afficheront pas le texte BoE/BoU."
...
L["Display abbreviated profession name on recipe items (e.g., BS for Blacksmithing)."] = "Afficher le nom abrégé de la profession sur les objets de recette (ex : BS pour Forge)."
...
L["Known Color"] = "Couleur (connu)"
L["Known Recipe Overlay"] = "Superposition pour recettes connues"
...
L["Show colored overlay for recipes that cannot be learned (wrong profession, level requirement not met, etc.)."] = "Afficher une superposition colorée pour les recettes qui ne peuvent pas être apprises (mauvaise profession, niveau insuffisant, etc.)."
L["Show colored overlay for recipes that are not yet known and can be learned."] = "Afficher une superposition colorée pour les recettes non connues mais apprenables."
L["Show colored overlay for recipes that are already known."] = "Afficher une superposition colorée pour les recettes déjà connues."
L["Show Profession Text"] = "Afficher le texte de la profession"
...
L["Unknown Color"] = "Couleur (inconnu)"
L["Unknown Recipe Overlay"] = "Superposition pour recettes inconnues"
L["Unlearnable Color"] = "Couleur (non apprenable)"
L["Unlearnable Recipe Overlay"] = "Superposition pour recettes non apprenables"
L["Up"] = "Haut"
L["Usable"] = "Uilisable"
...
L["YELL"] = "Crier"
L["Icon Size"] = "Taille de l'icône"
L["Set the size of the map markers"] = "Définir la taille des marqueurs de carte"
L["Receive from Raid Members"] = "Recevez des membres du raid"
L["Allows Raid Members to send you Map Markers"] = "Permet aux membres du raid de vous envoyer des marqueurs de carte"
L["MAP_MARKER_DISCRIPTION"] = "Permet de créer des marqueurs de carte en cliquant avec le bouton central (Souris3) sur la carte du monde.\nLes marqueurs sont automatiquement partagés avec les membres du raid."
