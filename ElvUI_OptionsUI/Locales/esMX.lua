...
L["Configure how recipe items are displayed in bags. Recipe items will not show BoE/BoU text."] = "Configura cómo se muestran los objetos de recetas en las bolsas. Los objetos de receta no mostrarán texto BoE/BoU."
...
L["Display abbreviated profession name on recipe items (e.g., BS for Blacksmithing)."] = "Mostrar el nombre abreviado de la profesión en los objetos de receta (p. ej., HS para Herrería)."
...
L["Known Color"] = "Color (conocido)"
L["Known Recipe Overlay"] = "Superposición para recetas conocidas"
...
L["Recipe Information"] = "Información de la receta"
...
L["Show Coins"] = true
L["Show colored overlay for recipes that cannot be learned (wrong profession, level requirement not met, etc.)."] = "Mostrar superposición de color para recetas que no pueden ser aprendidas (profesión incorrecta, requisito de nivel no cumplido, etc.)."
L["Show colored overlay for recipes that are not yet known and can be learned."] = "Mostrar superposición de color para recetas que aún no se conocen y pueden ser aprendidas."
L["Show colored overlay for recipes that are already known."] = "Mostrar superposición de color para recetas ya conocidas."
L["Show Profession Text"] = "Mostrar nombre de profesión"
...
L["Unknown Color"] = "Color (desconocido)"
L["Unknown Recipe Overlay"] = "Superposición para recetas desconocidas"
L["Unlearnable Color"] = "Color (no aprendible)"
L["Unlearnable Recipe Overlay"] = "Superposición para recetas no aprendibles"
L["Up"] = "Arriba"
L["Usable"] = true
L["Use Alt Key"] = true
...
L["Set the size of the map markers"] = "Establecer el tamaño de los marcadores del mapa"
L["Show Profession Text"] = "Mostrar nombre de profesión"
L["Unknown Color"] = "Color (desconocido)"
L["Unknown Recipe Overlay"] = "Superposición para recetas desconocidas"
L["Unlearnable Color"] = "Color (no aprendible)"
L["Unlearnable Recipe Overlay"] = "Superposición para recetas no aprendibles"
L["Receive from Raid Members"] = "Recibir de los miembros de la incursión"
L["Allows Raid Members to send you Map Markers"] = "Permite a los miembros de la incursión enviarte marcadores de mapa"
L["MAP_MARKER_DISCRIPTION"] = "Permite crear marcadores de mapa haciendo clic con el botón central (Mouse3) en el mapa mundial.\nLos marcadores se comparten automáticamente con los miembros de la redada."
