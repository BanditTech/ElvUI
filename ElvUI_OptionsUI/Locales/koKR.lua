...
L["Configure how recipe items are displayed in bags. Recipe items will not show BoE/BoU text."] = "가방에서 제작법 아이템의 표시 방식을 설정합니다. 제작법 아이템에는 착용 시 귀속(BoE)/사용 시 귀속(BoU) 텍스트가 표시되지 않습니다."
...
L["Display abbreviated profession name on recipe items (e.g., BS for Blacksmithing)."] = "제작법 아이템에 전문 기술의 약자를 표시합니다 (예: 대장기술은 'BS')."
...
L["Known Color"] = "이미 배운 색상"
L["Known Recipe Overlay"] = "이미 배운 제작법 오버레이"
...
L["Show colored overlay for recipes that cannot be learned (wrong profession, level requirement not met, etc.)."] = "전문 기술 불일치, 레벨 요구사항 미충족 등으로 습득할 수 없는 제작법에 대해 색상 오버레이를 표시합니다."
L["Show colored overlay for recipes that are not yet known and can be learned."] = "아직 배우지 않았지만 배울 수 있는 제작법에 색상 오버레이를 표시합니다."
L["Show colored overlay for recipes that are already known."] = "이미 배운 제작법에 색상 오버레이를 표시합니다."
L["Show Profession Text"] = "전문 기술 텍스트 표시"
...
L["Unknown Color"] = "미습득 색상"
L["Unknown Recipe Overlay"] = "미습득 제작법 오버레이"
L["Unlearnable Color"] = "습득 불가 색상"
L["Unlearnable Recipe Overlay"] = "습득 불가 제작법 오버레이"
L["Up"] = "위로"
L["Usable"] = "사용 가능"
...
L["YELL"] = "외침"
L["Icon Size"] = "아이콘 크기"
L["Set the size of the map markers"] = "맵 마커의 크기 설정"
L["Receive from Raid Members"] = "레이드 멤버로부터 받기"
L["Allows Raid Members to send you Map Markers"] = "레이드 멤버가 맵 마커를 보낼 수 있습니다."
L["MAP_MARKER_DISCRIPTION"] = "세계 지도에서 마우스 가운데 버튼(Mouse3)을 클릭하여 지도 마커를 생성할 수 있습니다.\n마커는 자동으로 공격대원과 공유됩니다."
